...
The function script is primarily for a [ProteomicsDB]() web scraper that can get proteomics data for individual protein lists and create a matrix for all protein x tissue values.
